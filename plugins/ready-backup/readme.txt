...
Backup your wordpress website to the DropBox, FTP, Local Computer or Email. Protect your website in easy and fast way.
...
* Website back up to Dropbox or FTP
...
Road map to the v0.5.4:

* New user interface
* More stability for large-size backups (over 500 Mb)
...
= 0.2.1 =
* Email back-up notifications
* Backup Plugin Ready compatability w��� WordPress 3.7.1
