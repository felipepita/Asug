...
function bupChangeDestOptions(){
	jQuery('input[name=dest_opt]').change(function() {
		if (jQuery(this).attr('class') == 'bupNotPaid'){
			...
			jQuery('.bupMsgDest').html('This option available in the <span style="color:#900;">RPO version</span>. <a href="http://readyshoppingcart.com/product/wordpress-backup-and-restoration-plugin/">More info</a>');
		} else {
