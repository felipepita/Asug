    ...
    <div class="container">
        <form id="bupWelcomePageFindUsForm">
            ...
            <div class="plug-icon-shell">
                ...
                <a target="_blank" href="http://readyshoppingcart.com/"><?php echo BUP_S_WP_PLUGIN_NAME?></a><br />
                <a target="_blank" href="http://readyshoppingcart.com/"><?php echo BUP_S_VERSION?></a><br />
            </div>
            <div class="clear"></div>
            ...
            <div class="video-wrapper">
               <iframe width="640" height="360" src="//www.youtube.com/embed/4c0Cg9MLqPs" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="clear"></div>
            ...
            <?php echo htmlBup::hidden('page', array('value' => 'promo_ready'))?>
