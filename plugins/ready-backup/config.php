<?php
	...
	define('BUP_PLUG_NAME_PRO', 'ready-backup-pro');
	...
	define('BUP_S_WP_PLUGIN_NAME', 'Ready! Backup');
    ...
    define('S_IMG_POSTS_PATH', BUP_IMG_PATH. 'posts/');
    ...
    define('BUP_MAIN_FILE', 'backup-ready.php');
    ...
    define('BUP_API_UPDATE_URL', 'http://somereadyapiupdatedomain.com');
