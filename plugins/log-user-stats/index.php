 ...
 * Plugin URI: http://wordpress.org/plugins/log-user-stats/
...
function freeman_add_user_minutes_column($columns) {
    $columns['total_time'] = 'Total de min';
    $columns['logged_in_amount'] = 'Qtde. de logins';
    $columns['average_time'] = 'Média min. de login';
    return $columns;
}
