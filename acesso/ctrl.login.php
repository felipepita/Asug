...
$company = 'C0011178858T1'; // instância / antigo: 'acevff'
$secret_key = 'asugkeysso1'; // key
$tklogin_key = 'novoportalasug'; // token
...
//			'tz' => $tz,
		...
		$login_url = 'https://performancemanager8.successfactors.com/login?' . $query;
