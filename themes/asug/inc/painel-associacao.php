...
<div class="wrap">
	<form id="form-painel-associacao" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
		...
		<h2 class="title">Notificações de Expiração</h2>
		
		<p>Liste abaixo os dias para os quais uma notificação de expiração será eviada ao representante da empresa.</p>
		
		<p>OBS: Notificações são enviadas automaticamente na véspera da expiração, ou seja, 1 dia antes. Não é necessário adicionar esse valor à lista.</p>
		...
		<table class="form-table">
			...
			<tbody>
				...
				<tr>
					<th scope="row">
						<label for="form-notificacao_degustacao">Dias para terminar a degustação</label>
					</th>
					<td>
						<input type="text" name="notificacao_degustacao" id="form-notificacao_degustacao" value="<?php print $associacao_config['notificacao_degustacao'] ?>">
						<p class="description">Separe os valores por vírgulas, com ou sem espaços.</p>
					</td>
				</tr>
			
				<tr>
					<th scope="row">
						<label for="form-notificacao_membro">Dias para terminar a associação</label>
					</th>
					<td>
						<input type="text" name="notificacao_membro" id="form-notificacao_membro" value="<?php print $associacao_config['notificacao_membro'] ?>">
						<p class="description">Separe os valores por vírgulas, com ou sem espaços.</p>
					</td>
				</tr>
