...
$estruturaPerfil->relacionar(
	...
	array(
		...
		array( null,					'fk_pk_cod_tip_usuario',	null,				null,					'funcao',				'role_funcao',			),
		array( 'division',				null,					null,					null,					'empresa_nome',			null,					),
		// array( 'location', '' ),
		// array( 'timeZone', '' ),
		...
		array( 'addressLine2',			'dsc_bairro_usu',		'bairro',				null,					'bairro',				'bairro',				),
		array( null,					'dsc_complemento_endereco_usu',	'complemento',	null,					'complemento',			'complemento',			),
		...
		array( 'custom01',				null,					null,					null,					'empresa_tipo_associacao',	null,				),
		array( 'custom02',				null,					'cargo_asug',			null,					'cargo_asug',			'cargo_asug',			),
		...
		// array( 'custom08',				null,					null,					null,					'representante1_telefone',	null,				),
...
$estruturaEmpresa->relacionar(
	...
	array(
		...
		array(	'versao_ERP',				'versao_erp',			null,					'versao_erp',			'versao_erp',			),
		array(  'dsc_dominio_email',		'sufixo',				null,					'sufixo',				'sufixo',				),
		array(  'site',						null,					'user_url',				'user_url',				null,					),
		array(	null,						null,					'role',					'role',					'role_associacao',		),
		...
		array(	null,						'representante1',		null,					'representante1',		'rep1_user_id',			),
